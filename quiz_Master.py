...
score = 0
time_left = 10 
question_flie_name = "questions.txt"
marquee_message = ""
is_game_over = False
...
def draw():
    ...
    for box in answer_boxes:
        screen.draw.filled_rect(box , "dark orange")
        ...
        screen.draw.textbox(
            ...
            color="white", shawdow=(0.5,0.5),
            scolor="dim grey"
        )
        index = 1
        for answer_box in answer_boxes:
            screen.draw.textbox(questiion[index].strip(), anwser_box, color="black")
            index= index + 1
...
def read_question_file():
    ...
    q_file=open(question_flie_name, "r")
